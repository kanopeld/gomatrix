...
func (cli *Client) Sync(ctx context.Context) error {
	...
	go func() {
		_ = cli.listener.scanEvents(ctx)
	}()

	for {
		resSync, err := cli.SyncRequest(ctx, cli.RequestTimeout, nextBatch, filterID, false, "")
		if err != nil {
...
func (cli *Client) incrementSyncingID() uint32 {
	atomic.AddUint32(&cli.syncingID, 1)
	return cli.getSyncingID()
}
...
func (cli *Client) CreateFilter(ctx context.Context, filter json.RawMessage) (resp *RespCreateFilter, err error) {
	...
	err = cli.MakeRequest(ctx, http.MethodPost, urlPath, &filter, &resp)
	return
}

// SyncRequest makes an HTTP request according to http://matrix.org/docs/spec/client_server/r0.2.0.html#get-matrix-client-r0-sync
func (cli *Client) SyncRequest(ctx context.Context, timeout time.Duration, since, filterID string, fullState bool, setPresence string) (resp *RespSync, err error) {
	...
	err = cli.MakeRequest(ctx, http.MethodGet, urlPath, nil, &resp)
	return
}
...
func (cli *Client) register(ctx context.Context, u string, req *ReqRegister) (resp *RespRegister, uiaResp *RespUserInteractive, err error) {
	err = cli.MakeRequest(ctx, http.MethodPost, u, req, &resp)
	if err != nil {
...
func (cli *Client) Login(ctx context.Context, req *ReqLogin) (resp *RespLogin, err error) {
	...
	err = cli.MakeRequest(ctx, http.MethodPost, urlPath, req, &resp)
	return
}
...
func (cli *Client) Logout() (ctx context.Context, resp *RespLogout, err error) {
	...
	err = cli.MakeRequest(ctx, http.MethodPost, urlPath, nil, &resp)
	return
}
...
func (cli *Client) PublicRoomsFiltered(ctx context.Context, limit int, since string, server string, filter string) (resp *RespPublicRooms, err error) {
	...
	err = cli.MakeRequest(ctx, http.MethodPost, urlPath, content, &resp)
	return
}
...
func (cli *Client) SetDisplayName(ctx context.Context, displayName string) (err error) {
	...
	err = cli.MakeRequest(ctx, http.MethodPut, urlPath, &s, nil)
	return
}
...
func (cli *Client) GetAvatarURL(ctx context.Context) (string, error) {
	...
	err := cli.MakeRequest(ctx, http.MethodGet, urlPath, nil, &s)
	if err != nil {
		return "", err
	}
...
func (cli *Client) SendMessageEvent(ctx context.Context, roomID string, eventType EventType, contentJSON interface{}) (resp *RespSendEvent, err error) {
	txnID := txnID()
	urlPath := cli.BuildURL("rooms", roomID, "send", eventType.String(), txnID)
	err = cli.MakeRequest(ctx, http.MethodPut, urlPath, contentJSON, &resp)
	return
}
...
func (cli *Client) SendText(ctx context.Context, roomID, text string) (*RespSendEvent, error) {
	return cli.SendMessageEvent(ctx, roomID, MessageEventType,
...
func (cli *Client) RedactEvent(ctx context.Context, roomID, eventID string, req *ReqRedact) (resp *RespSendEvent, err error) {
	...
	err = cli.MakeRequest(ctx, http.MethodPut, urlPath, req, &resp)
	return
}
...
func (cli *Client) MarkRead(ctx context.Context, roomID, eventID string) error {
	...
	return cli.MakeRequest(ctx, http.MethodPost, urlPath, nil, nil)
}
...
func (cli *Client) LeaveRoom(ctx context.Context, roomID string) (resp *RespLeaveRoom, err error) {
	...
	err = cli.MakeRequest(ctx, http.MethodPost, u, struct{}{}, &resp)
	return
}
...
func (cli *Client) UserTyping(ctx context.Context, roomID string, typing bool, timeout int64) (resp *RespTyping, err error) {
	...
	err = cli.MakeRequest(ctx, http.MethodPut, u, req, &resp)
	return
}
...
func (cli *Client) StateEvent(ctx context.Context, roomID string, eventType EventType, stateKey string, outContent interface{}) (err error) {
	...
	err = cli.MakeRequest(ctx, http.MethodGet, u, nil, outContent)
	return
}
...
func (cli *Client) JoinedMembers(ctx context.Context, roomID string) (resp *RespJoinedMembers, err error) {
	...
	err = cli.MakeRequest(ctx, http.MethodGet, u, nil, &resp)
	return
}
...
func (cli *Client) CreateRoomAlias(ctx context.Context, alias string, req *ReqCreateRoomAlias) error {
	urlPath := cli.BuildURL("directory", "room", alias)
	return cli.MakeRequest(ctx, http.MethodPut, urlPath, req, nil)
}
...
func (cli *Client) ResolveRoomsIDs(ctx context.Context, alias string) (resp *RespResolveRoomsIDs, err error) {
	urlPath := cli.BuildURL("directory", "room", alias)
	err = cli.MakeRequest(ctx, http.MethodGet, urlPath, nil, resp)
	return
}
...
func (cli *Client) DeleteRoomAlias(ctx context.Context, alias string) error {
	urlPath := cli.BuildURL("directory", "room", alias)
	return cli.MakeRequest(ctx, http.MethodDelete, urlPath, nil, nil)
}
...
func (cli *Client) RoomAliases(ctx context.Context, roomID string) (resp *RespRoomAliases, err error) {
...
const DefaultEventsChanBufferSize = 16
...
func NewClient(homeserverURL, userID, accessToken string) (*Client, error) {
	...
	eventsChan := make(chan *Event, DefaultEventsChanBufferSize)
